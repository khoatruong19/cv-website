        ...
        <form class="position-relative" action="">
            ...
            <div class="position-absolute col-md-4 w-25" style="right: 5vh;">
                ...
                <div class="d-block mb-4 d-flex justify-content-center align-items-center">
                    <button type="submit" class="cus_next btn btn-primary rounded-3 d-block border-input text-dark shadow" style="background-color: rgb(214, 225, 242);">Upload</button>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-md-4">
                    <label for="det_firstName" class="form-label">First Name</label>
                    <input type="text" class="form-control border-input " id="first_name">
                </div>
                <div class="col-md-4">
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control border-input shadow" id="det_mail">
                </div>
                <div class="col-md-4">
                    <label for="det_phone" class="form-label">Phone No</label>
                    <input type="text" class="form-control border-input shadow"  id="det_phone">
                </div>
            </div>
            <!-- <div class="col-md-6"></div> -->
            <div class="col-md-8">
                <label for="det_url" class="form-label">Address</label>
                <input type="text" class="form-control border-input shadow" id="det_address">
            </div>
            <div class="col-md-8">
